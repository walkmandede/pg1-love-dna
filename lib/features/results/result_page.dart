...
import 'package:pg1/features/results/widgets/metric_row.dart';
import 'package:pg1/features/results/widgets/small_type_card.dart';
import 'package:pg1/features/results/widgets/type_card.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: SmallTypeCard(label: 'Stabiliser', typeName: result.types.stabiliser, icon: Icons.balance),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                        child: SmallTypeCard(label: 'Growth', typeName: result.types.growth, icon: Icons.trending_up),
                      ),
                    ],
                  ),
                  ...
                  MetricRow(label: 'Trust Score', value: result.derivedMetrics.trustScore.toString(), icon: Icons.handshake_outlined),
                  MetricRow(label: 'Contradiction Index', value: result.derivedMetrics.contradictionIndex, icon: Icons.compare_arrows),
                  MetricRow(label: 'Stability Outlook', value: result.derivedMetrics.stabilityOutlook, icon: Icons.insights),
